...
![Chessboard images for calibration](https://github.com/brodgon/brodgon.github.io/blob/master/docs/imagen_inicial_a_reconstruir.png?raw=true)
...
![Detection](https://github.com/brodgon/brodgon.github.io/blob/master/docs/imagen_inicial_a_reconstruir.png?raw=true)
...
![Camera Position single image](https://github.com/brodgon/brodgon.github.io/blob/master/docs/imagen_inicial_a_reconstruir.png?raw=true)

Making sure evrything was working, the next step is to move towards video. Although this may be difficult, its implementation is pretty straightfoward since we just have to understand the video as a collection of images. In this sense, two scenarios were tested: using a 'pre-recorded video' and performing 'real-time tracking'. Results for the first ones are shown below or by clicking [on this link]().
